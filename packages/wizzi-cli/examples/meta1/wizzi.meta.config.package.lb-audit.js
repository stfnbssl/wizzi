/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\.wizzi\examples\meta1\wizzi.meta.config.package.lb-audit.js.ittf
...
module.exports = {
    meta: "meta-package-lb-audit", 
    metaCtxPath: path.join(__dirname, "ittf", "lb-audit.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/lavori/logbot-cybersecurity/packages/lb-audit", 
    plugins: [
