...
module.exports = {
    meta: "example-meta1-plugin-ai", 
    metaCtxPath: path.join(__dirname, '_meta', 'meta.plugin.ai.json.ittf'), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.ai",
    plugins: [
