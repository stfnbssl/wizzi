/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\ittf\step_4.js.ittf
*/
'use strict';
//
...
var Schemas_ittf_step_4 = function(step_callback) {
    heading1('EXAMPLE')
    heading2('Ittf builtin schema')
    loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'basic.ittf.ittf'), {}, "ittf/tojson", function(err, artifactText) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        heading2('Ittf builtin schema - artifact ittf/tojson')
        printValue('ittf/tojson', artifactText);
    })
};
Schemas_ittf_step_4.__name = 'Schemas_ittf_step_4';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - Schemas_ittf_step_4 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_ittf_step_4 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_ittf_step_4;
