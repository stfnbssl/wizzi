/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\text\step_2.js.ittf
*/
'use strict';
//
...
var Schemas_json_step_2 = function(step_callback) {
    heading1('EXAMPLE')
    loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'basic.text.ittf'), {}, "text/document", function(err, artifactText) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        printValue('text', artifactText);
    })
};
