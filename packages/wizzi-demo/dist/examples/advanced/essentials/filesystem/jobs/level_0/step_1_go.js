/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\jobs\level_0\step_1_go.js.ittf
*/
'use strict';
...
var artifactContext = {};
var globalContext = {};
var wizzi_job_simple = function(step_callback) {
    ...
    wizzi.executeWizziJob({
        ...
        job: {
            name: 'simple', 
            ittfDocumentUri: path.join(__dirname, 'step_1', 'step_1.wfjob.ittf'), 
...
wizzi_job_simple.__name = 'Level 0 - wizzi_job_simple';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wizzi_job_simple - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzi_job_simple - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wizzi_job_simple;
