/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\jobs\level_1\step_1_go.js.ittf
*/
'use strict';
...
var artifactContext = {};
var globalContext = {};
var wizzi_job_modelTypes = function(step_callback) {
    ...
    wizzi.executeWizziJob({
        ...
        job: {
            name: 'model_types', 
            ittfDocumentUri: path.join(__dirname, 'step_1', 'model_Types.wfjob.ittf'), 
        ...
        printValue('Result', 'Wizzi job model_types SUCCESSFULLY executed\n' + JSON.stringify(result, null, 2), 'dashes')
        if (step_callback) {
            step_callback(null)
        }
    })
};
wizzi_job_modelTypes.__name = 'Level 1 - wizzi_job_modelTypes';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 1 - step 1 - wizzi_job_modelTypes - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzi_job_modelTypes - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wizzi_job_modelTypes;
if (typeof require != 'undefined' && require.main === module) {
    wizzi_job_modelTypes();
}
