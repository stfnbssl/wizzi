/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\jobs\level_1\step_2_go.js.ittf
*/
'use strict';
...
function heading1(text) {
    ...
    console.log('** level 1 - step 2 - wizzi_job_wizziJobs - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzi_job_wizziJobs - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wizzi_job_wizziJobs;
