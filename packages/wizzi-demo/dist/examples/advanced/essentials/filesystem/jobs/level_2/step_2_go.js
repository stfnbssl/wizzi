/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-demo\.wizzi\examples\advanced\essentials\filesystem\jobs\level_2\step_2_go.js.ittf
*/
'use strict';
...
var wizzi_job = function(step_callback) {
    ...
    wizzi.executeWizziJob({
        ...
        job: {
            name: 'level_2_html_schema', 
            ittfDocumentUri: path.join(__dirname, 'step_2', 'html_schema.wfjob.ittf'), 
        ...
        printValue('Result', 'Wizzi job level_2_html_schema SUCCESSFULLY executed\n' + JSON.stringify(result, null, 2), 'dashes')
        if (step_callback) {
            step_callback(null)
        }
    })
...
function heading1(text) {
    ...
    console.log('** level 2 - step 2 - wizzi_job - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
