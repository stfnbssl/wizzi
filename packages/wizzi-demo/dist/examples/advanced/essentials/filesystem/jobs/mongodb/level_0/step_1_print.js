/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-demo\src\ittf\examples\advanced\essentials\filesystem\jobs\mongodb\level_0\step_1_print.js.ittf
...
var artifactContext = {};
var globalContext = {};
var wizzi_job_mongodb_level_0_step_1_print = function(step_callback) {
...
wizzi_job_mongodb_level_0_step_1_print.__name = 'Level 0 - wizzi_job_mongodb_level_0_step_1_print';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wizzi_job_mongodb_level_0_step_1_print - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzi_job_mongodb_level_0_step_1_print - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wizzi_job_mongodb_level_0_step_1_print;
if (typeof require != 'undefined' && require.main === module) {
    wizzi_job_mongodb_level_0_step_1_print();
}
