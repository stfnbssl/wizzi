/*
    ...
    primary source IttfDocument: c:\my\wizzi\v5\apps\wizzi-demo\src\ittf\examples\advanced\essentials\filesystem\jobs\mongodb\level_0\step_2_go.js.ittf
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - wizzi_job_mongodb - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzi_job_mongodb - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wizzi_job_mongodb;
