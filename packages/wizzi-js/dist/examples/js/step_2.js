/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-js\.wizzi\ittf\examples\js\step_2.js.ittf
*/
'use strict';
//
...
var js_step_2 = function(step_callback) {
    heading1('EXAMPLE')
...
js_step_2.__name = 'js_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 2 - js_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
