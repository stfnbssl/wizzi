/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-js\.wizzi\lib\artifacts\js\module\gen\main.js.ittf
*/
'use strict';
...
md.gen = function(model, ctx, callback) {
    ...
    if (model.wzElement !== 'xmodule') {
        console.log("[31m%s[0m", 'v6-wizzi-js', 'artifact', 'model', model);
