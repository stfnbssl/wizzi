/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-lab\.wizzi\examples\regexp\step_2_go.js.ittf
*/
'use strict';
    ...
    wizzi.fsFactory({
        ...
        load(function(err, mTreeModel) {
            ...
            wizzi.fsFactory(wizziFactoryConfig, function(err, wf) {
                ...
                wf.loadModel(path.join(__dirname, 'step_2', 'css.regexp.ittf'), {}, function(err, wizziModel) {
                    if (err) {
                        console.log("[31m%s[0m", err);
                        throw new Error(err.message);
                    }
