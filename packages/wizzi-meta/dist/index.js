/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-meta\.wizzi\ittf\root\index.js.ittf
*/
'use strict';
...
function error(code, message) {
    return {
            __is_error: true, 
            source: 'wizzi-meta/FactoryPlugin', 
            code: code, 
            message: message
         };
}
