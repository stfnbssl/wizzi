...
var wfpackage = (function (commentable) {
    ...
    wfpackage.prototype.toJsonChildren = function(result) {
        ...
        items = [];
        this.generatedPackages.forEach((item) => {
            items.push(item.toJson());
        });
...
var ittf = (function (commentable) {
    ...
    ittf.prototype.toJsonChildren = function(result) {
        ...
        var items, item;
        items = [];
        this.fragmentRefs.forEach((item) => {
            items.push(item.toJson());
        });
...
var wfpackageModelException = (function () {
    ...
    wfpackageModelException.prototype.toString = function() {
        var msg = [];
        msg.push(chalk.red('Error: ' + this.message));
        msg.push(chalk.red('  name: wfpackageModelException'));
        if (this.node) {
