/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\ittf\examples\jswizzi\step_docx.js.ittf
*/
'use strict';
//
...
var jsWizzi_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var context = file.readJSON(path.join(__dirname, 'ittf', 'functions', 'first.docx.json'));
    var ittfUri = path.join(__dirname, 'ittf', 'functions', 'first.docx.ittf');
