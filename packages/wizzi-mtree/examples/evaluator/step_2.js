/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\evaluator\step_2.js.ittf
...
var Evaluator_Step_2 = function(step_callback) {
    heading1('EXAMPLE')
    var ittfUri = path.join(__dirname, 'ittf', 'setget_prod_ctx.js.ittf');
    ...
    getFSDocumentStore(function(err, fsStore) {
        ...
        MTreeBrickProvider.createFromUri(ittfUri, {
            ...
            printNodes(mTree.nodes, 'Before evaluate');
            mixer(mTree, provider, function(err, mixedModel) {
                ...
                appender(mixedModel, function(err, appendedModel) {
                    ...
                    evaluator(appendedModel, loadContext, function(err, evaluatedModel) {
                        ...
                        printEvaluatedNodes(evaluatedModel, 'After evaluate');
                    })
                })
            })
        })
...
Evaluator_Step_2.__name = 'Evaluator_Step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Evaluator_Step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Evaluator_Step_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Evaluator_Step_2;
