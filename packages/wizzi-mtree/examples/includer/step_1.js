...
var Includer_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var ittfUri = path.join(__dirname, 'ittf', 'includer_1.js.ittf');
    getFSDocumentStore(function(err, fsStore) {
        ...
        MTreeBrickProvider.createFromUri(ittfUri, {
            ...
            printNodes(mTree.nodes, 'Before include');
            includer(mTree, provider, function(err, includedModel) {
                ...
                printNodes(includedModel.nodes, 'After include');
            })
        })
    })
};
Includer_Step_1.__name = 'Includer_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Includer_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Includer_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Includer_Step_1;
