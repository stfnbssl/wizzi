/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\jswizzi\functions\step_docx.js.ittf
...
var jsWizzi_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var context = file.readJSON(path.join(__dirname, 'first.docx.json'));
    var ittfUri = path.join(__dirname, 'ittf', 'first.docx.ittf');
