/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\jswizzi\test_1.js.ittf
    utc time: Tue, 30 Jul 2024 07:41:31 GMT
*/
'use strict';
//
...
var jsWizzi_Step_1 = function(step_callback) {
    ...
    var ittfUri = path.join(__dirname, 'ittf', 'functions', 'test_4.ittf.ittf');
    ...
    getFSDocumentStore(function(err, fsStore) {
        ...
        loader.loadMTree(ittfUri, {
            ...
            console.log('mTree.toIttf()', mTree.toIttf(), __filename);
        })
    })
    function sampleExecution() {
        console.log('-- Enter sampleExecution', __filename);
        var x = 0;
        console.log('-- Set x = 0', __filename);
        function a() {
            x++;
            console.log('-- Increment x in a = ', x, __filename);
            var ax = 0;
            console.log('-- Set ax = 0', __filename);
            function b() {
                var bx = 0;
                console.log('-- Set bx = 0', __filename);
                x++;
                console.log('-- Increment x in b = ', x, __filename);
            }
            b();
            console.log('-- Test x', x, __filename);
            if (x < 5) {
                a();
            }
        }
...
jsWizzi_Step_1.__name = 'jsWizzi_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - jsWizzi_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- jsWizzi_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
