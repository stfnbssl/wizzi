/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\jswizzi\test_2.js.ittf
...
var jsWizzi_Test_2 = function(step_callback) {
    heading1('EXAMPLE')
    var x = runExpression("return 2 + 2");
    console.log('result', x, __filename);
...
jsWizzi_Test_2.__name = 'jsWizzi_Test_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - jsWizzi_Test_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- jsWizzi_Test_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
