/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\loadCompile\step_1.js.ittf
...
var loadCompile_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var ittfUri = path.join(__dirname, 'ittf', 'basic.html.ittf');
...
loadCompile_Step_1.__name = 'loadCompile_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - loadCompile_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- loadCompile_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = loadCompile_Step_1;
