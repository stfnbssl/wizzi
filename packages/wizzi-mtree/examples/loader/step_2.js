/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\examples\loader\step_2.js.ittf
...
var Evaluator_Step_2 = function(step_callback) {
    heading1('EXAMPLE')
    var ittfUri = path.join(__dirname, 'ittf', 'frontmatter_1.html.ittf');
    ...
    getFSDocumentStore(function(err, fsStore) {
        ...
        loader.loadMTreeFrontMatter(ittfUri, {
            mTreeBuildUpContext: {}, 
            ...
            // loog 'mTree', mTree
            printNodes(mTree.nodes, 'After evaluate');
        })
    })
};
