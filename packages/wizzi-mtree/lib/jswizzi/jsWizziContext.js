...
var JsWizziContext = (function () {
    ...
    */
    ...
    JsWizziContext.prototype.enterFunctionEvalContext = function(functionName) {
        var previousFunctionName = this.brickEvalContext.enterFunction(functionName);
        return {
                brickKey: this.currentMTreeBrickKey, 
                functionName: previousFunctionName
             };
    }
    JsWizziContext.prototype.exitFunctionEvalContext = function(brickKey, functionName) {
        ...
        brickEvalContext.enterFunction(functionName)
    }
