/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\lib\jswizzi\jsWizziScriptCoder.js.ittf
...
var JsWizziScriptCoder = (function () {
    ...
    JsWizziScriptCoder.prototype.for = function(text, node) {
        ...
        this.w('for (' + text + ') {' + nodeMapComment(node));
        this.indent();
    }
    JsWizziScriptCoder.prototype.if = function(text, node) {
        ...
        this.map[this.length] = node;
        this.w('if (' + text + ') {' + nodeMapComment(node));
        this.indent();
    }
    JsWizziScriptCoder.prototype.elif = function(text, node) {
        ...
        this.map[this.length] = node;
        this.w('else if (' + text + ') {' + nodeMapComment(node));
        this.indent();
    }
    ...
    JsWizziScriptCoder.prototype.while = function(text, node) {
        ...
        this.map[this.length] = node;
        this.w('while (' + text + ') {' + nodeMapComment(node));
        this.indent();
    }
    JsWizziScriptCoder.prototype.throw = function(text, node) {
        this.w('throw new Error(' + text + ')');
    }
