/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\ittf\examples\json\store\step_1.js.ittf
*/
'use strict';
//
...
var Json_Store_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    heading1('start');
...
Json_Store_Step_1.__name = 'Json_Store_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Json_Store_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Json_Store_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Json_Store_Step_1;
