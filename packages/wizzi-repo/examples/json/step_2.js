/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\examples\json\step_2.js.ittf
...
var Json_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    heading1('start');
    var jsonDirectoryTree = json.directoryTree(path.join(__dirname, '..'));
...
function heading1(text) {
    ...
    console.log('** level 0 - step 2 - Json_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
