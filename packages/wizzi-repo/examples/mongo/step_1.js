/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\examples\mongo\step_1.js.ittf
...
var Mongo_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
...
Mongo_Step_1.__name = 'Mongo_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Mongo_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
