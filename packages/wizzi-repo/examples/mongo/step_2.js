/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\examples\mongo\step_2.js.ittf
...
function heading1(text) {
    ...
    console.log('** level 0 - step 2 - Mongo_Step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
