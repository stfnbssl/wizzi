/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\examples\mongo\step_4.js.ittf
...
function heading1(text) {
    ...
    console.log('** level 0 - step 3 - Mongo_Step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
