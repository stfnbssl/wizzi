/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-scripts\.wizzi\examples\codemods\index.js.ittf
*/
'use strict';
...
codemods.copyChangeWizziSchema('C:/My/wizzi/stfnbssl/__workings/wizzi-examples/packages/wizzi-studio/dist/server/data/models/cheatsheets', 'C:/My/wizzi/stfnbssl/wizzi.apps/packages/wizzi.webapp/dist/ittf/models/cheatsheets', 'meta', 'ittf', function(err, result) {
    if (err) {
        return callback(err);
    }
    console.log('codemods.copyChangeWizziSchema', result);
})
