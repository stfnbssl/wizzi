/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-scripts\.wizzi\lib\codemods.js.ittf
*/
'use strict';
...
var Codemods = (function () {
    ...
    Codemods.prototype.copyChangeWizziSchema = function(fromFolder, toFolder, oldWizziSchema, newWizziSchema, callback) {
        console.log('copyChangeWizziSchema', 'from', fromFolder, 'to', toFolder,);
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (parts[parts.length -1] == 'ittf' && parts[parts.length -2] == oldWizziSchema) {
                ...
                console.log('new item.file', newItemFile);
