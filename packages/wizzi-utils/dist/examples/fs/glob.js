/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\ittf\examples\fs\glob.js.ittf
*/
'use strict';
//
...
var glob = fs.glob;
var file = fs.vfile();
var glob_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
...
glob_Step_1.__name = 'glob_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - glob_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
