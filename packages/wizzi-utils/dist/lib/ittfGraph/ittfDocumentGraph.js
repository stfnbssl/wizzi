/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\ittf\lib\ittfGraph\ittfDocumentGraph.js.ittf
*/
'use strict';
...
var IttfDocumentGraph = (function () {
    ...
    IttfDocumentGraph.prototype.preAdd = function(name, value) {
        if ({}.toString.call(name) === '[object Object]' && name.name) {
            ...
            return new IttfDocumentGraph(name, value, this);
        }
    }
    ...
    IttfDocumentGraph.prototype.isCommand = function() {
    ...
    IttfDocumentGraph.prototype.isCodeDeclare = function() {
        return this.name && ['$', '$global'].indexOf(this.name) == 0;
    }
    IttfDocumentGraph.prototype.isMultilineDeclare = function() {
