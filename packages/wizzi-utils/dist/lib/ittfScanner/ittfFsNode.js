/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\ittf\lib\ittfScanner\ittfFsNode.js.ittf
*/
'use strict';
...
var IttfFsNode = (function () {
    ...
    IttfFsNode.prototype.__setInfo = function(r, callback) {
        ...
        if (this.isDirectory) {
            var that = this;
            async.map(this.folders, function(item, callback) {
