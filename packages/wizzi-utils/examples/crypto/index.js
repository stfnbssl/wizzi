/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\crypto\index.js.ittf
    utc time: Wed, 12 Jun 2024 06:21:07 GMT
*/
'use strict';
/**
     Example: encdec_Step_1
...
var encdec_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
...
encdec_Step_1.__name = 'encdec_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - encdec_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- encdec_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
