/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\fs\getFiles.js.ittf
    utc time: Thu, 09 May 2024 12:31:23 GMT
*/
'use strict';
/**
     Example: getFiles_Step_1
...
var file = vfile();
var getFiles_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
...
getFiles_Step_1.__name = 'getFiles_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - getFiles_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- getFiles_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = getFiles_Step_1;
