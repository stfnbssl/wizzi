/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\fs\getFolders.js.ittf
    utc time: Thu, 09 May 2024 12:31:23 GMT
*/
'use strict';
/**
     Example: getFolders_Step_1
...
var file = vfile();
var getFolders_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
...
getFolders_Step_1.__name = 'getFolders_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - getFolders_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- getFolders_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = getFolders_Step_1;
