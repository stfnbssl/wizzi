/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\fs\utils.js.ittf
    utc time: Sat, 30 Mar 2024 12:44:02 GMT
*/
'use strict';
/**
     Example: fsUtils_Step_1
...
var fsUtils_Step_1 = function(step_callback) {
    ...
    printObject(fsUtils.fileInfoByPath(fname))
    fname = path.join(__dirname, 't', 'test.html.ittf')
    ;
    printObject(fsUtils.fileInfoByPath(fname, __dirname))
};
fsUtils_Step_1.__name = 'fsUtils_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - fsUtils_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- fsUtils_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
