/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\helpers\textIndentParser.js.ittf
...
var textIndentParser_Step_1 = function(step_callback) {
    ...
    var lines = tip.parse(text);
    console.log('lines', lines, __filename);
    var nodes = tip.nodify(lines);
    console.log('nodes 1', nodes, __filename);
    var ret = {
        children: [
            
        ]
     };
    var nodes2 = tip.nodify(text, ret);
    console.log('nodes 2', JSON.stringify(obj.decycle(ret), null, 2), __filename);
};
