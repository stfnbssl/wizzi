/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\helpers\verify.js.ittf
    utc time: Wed, 03 Jul 2024 03:15:57 GMT
*/
'use strict';
/**
     Example: verify_Step_1
...
var verify_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var nv;
...
verify_Step_1.__name = 'verify_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - verify_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- verify_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
