/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\ittfGraph\asisLoader\index.js.ittf
    utc time: Wed, 03 Jul 2024 03:15:57 GMT
*/
'use strict';
/**
     Example: asIsLoader_Step_1
...
var asIsLoader_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    fs.vfile(function(err, file) {
        if (err) {
    ...
    function step_1(file) {
        ittfGraph.createAsIsLoaderFromString([
            'module', 
            '    kind react', 
            '    react Hello', 
            '        state', 
    ...
    function step_3(file) {
        ittfGraph.asIsLoader(path.join(__dirname, 'ittf', 'basic.tests.ittf'), {
            clean_remove: true, 
            file: file
         }, function(err, tree) {
            if (err) {
...
asIsLoader_Step_1.__name = 'asIsLoader_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - asIsLoader_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- asIsLoader_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = asIsLoader_Step_1;
