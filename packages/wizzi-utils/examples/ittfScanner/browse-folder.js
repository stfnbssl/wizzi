/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\ittfScanner\browse-folder.js.ittf
    utc time: Sat, 30 Mar 2024 12:44:02 GMT
*/
'use strict';
/**
     Example: ittfScanner_browse_folder
...
var ittfScanner_browse_folder = function(step_callback) {
    heading1('EXAMPLE')
    const folderPath = path.join(__dirname, 'ittf', 'scan-ittf');
    ittfScanner.browseFolder(folderPath, {
        ...
        file.write(path.join(__dirname, 'outputs', 'browse-folder', 'browse_result.json'), stringify(result, null, 2))
    })
};
ittfScanner_browse_folder.__name = 'ittfScanner_browse_folder';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - ittfScanner_browse_folder - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- ittfScanner_browse_folder - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = ittfScanner_browse_folder;
if (typeof require != 'undefined' && require.main === module) {
    ittfScanner_browse_folder();
}
