/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\ittfScanner\scan-ittf-folder.js.ittf
    utc time: Sat, 30 Mar 2024 12:44:02 GMT
*/
'use strict';
/**
     Example: ittfScanner_scan_ittf_folder
...
const rootFolder = path.join(__dirname, 'ittf');
ittfScanner.scanFolder(folderPath, {
    ...
    file.write(path.join(__dirname, 'outputs', 'scan-ittf-folder', 'scan-ittf-folder-result-graph.json'), stringify(result, null, 2))
})
var ittfScanner_scan_ittf_folder = function(step_callback) {
    heading1('EXAMPLE')
};
ittfScanner_scan_ittf_folder.__name = 'ittfScanner_scan_ittf_folder';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - ittfScanner_scan_ittf_folder - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- ittfScanner_scan_ittf_folder - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = ittfScanner_scan_ittf_folder;
if (typeof require != 'undefined' && require.main === module) {
    ittfScanner_scan_ittf_folder();
}
