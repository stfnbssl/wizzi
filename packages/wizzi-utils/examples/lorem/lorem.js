/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\lorem\lorem.js.ittf
    utc time: Thu, 09 May 2024 12:31:23 GMT
*/
'use strict';
/**
     Example: lorem_Step_1
...
var lorem_Step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var text = lorem({
        count: 100
     });
...
lorem_Step_1.__name = 'lorem_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - lorem_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
