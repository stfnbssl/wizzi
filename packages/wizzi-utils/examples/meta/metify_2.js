/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\meta\metify_2.js.ittf
...
const destFolder = path.join(__dirname, 'outputs', 'wizzi');
...
meta_metify.__name = 'meta_metify';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - meta_metify - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
