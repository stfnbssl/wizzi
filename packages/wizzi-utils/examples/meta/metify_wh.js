/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\examples\meta\metify_wh.js.ittf
    utc time: Thu, 09 May 2024 12:31:23 GMT
*/
'use strict';
/**
     Example: meta_metify_wh
...
const folderPath = path.join(__dirname, 'ittf', 'wizziHub');
const rootFolder = path.join(__dirname, 'ittf', 'wizziHub');
...
var meta_metify_wh = function(step_callback) {
    heading1('EXAMPLE')
};
meta_metify_wh.__name = 'meta_metify_wh';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - meta_metify_wh - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- meta_metify_wh - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
