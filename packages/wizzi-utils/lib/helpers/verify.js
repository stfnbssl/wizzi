...
;
md.isObjectNotBuiltIn = function(test) {
    if (test === null || typeof(test) === 'undefined') {
        return false;
    }
    if ((test instanceof Boolean) || (test instanceof Date) || (test instanceof Number) || (test instanceof RegExp) || (test instanceof String)) {
        return false;
    }
    return {}.toString.call(test) === '[object Object]';
}
...
;
md.filter = function(items, prop, value) {
    return items.filter(function(a) {
            return a[prop] === value;
        });
}
;
md.unique = function(items) {
    var result = [];
