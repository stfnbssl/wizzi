/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-web\.wizzi\examples\site\index.js.ittf
*/
'use strict';
...
function executeExample() {
    ...
    function execute(name) {
        ...
        loadModel(ittfSource, {
            ...
            // loog 'site wizziModel', wizziModel
            var demos = wizziModel.getDemosByPath('javascript/bundlers');
            // loog 'demos(Javascript/Bundlers)', demos
            var cats = wizziModel.getCategoriesByPath('javascript');
            // loog 'categories(Javascript/Bundlers)', cats
        })
    }
}
