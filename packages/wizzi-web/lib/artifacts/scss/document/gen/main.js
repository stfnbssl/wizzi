/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-web\.wizzi\lib\artifacts\scss\document\gen\main.js.ittf
*/
'use strict';
...
md.gen = function gen(model, ctx, callback) {
    ...
    getGenItem(ctx)(model, function(err, notUsed) {
        ...
        console.log(myname, 'exit err', err, __filename);
