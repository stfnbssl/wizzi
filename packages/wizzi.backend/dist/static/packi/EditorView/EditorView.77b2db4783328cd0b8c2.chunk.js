...
/*
    ...
    utc time: Tue, 20 Jul 2021 16:43:43 GMT
*/
...
function getPageMetadata(props) {
  ...
  const url = `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1626799548383}).PACKI_SERVER_URL}${props.id ? `/${props.id}` : ''}
    `;
...
//# sourceMappingURL=EditorView.77b2db4783328cd0b8c2.chunk.js.map