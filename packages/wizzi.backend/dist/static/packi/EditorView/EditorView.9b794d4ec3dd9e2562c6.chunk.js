...
function getPageMetadata(props) {
  ...
  const url = `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1626807414685}).PACKI_SERVER_URL}${props.id ? `/${props.id}` : ''}
    `;
...
//# sourceMappingURL=EditorView.9b794d4ec3dd9e2562c6.chunk.js.map