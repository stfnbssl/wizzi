...
/*
    ...
    utc time: Tue, 20 Jul 2021 18:06:22 GMT
*/
...
function getPageMetadata(props) {
  ...
  const url = `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1626804577964}).PACKI_SERVER_URL}${props.id ? `/${props.id}` : ''}
    `;
...
//# sourceMappingURL=EditorView.d4f90cc0bd0fa040efaa.chunk.js.map