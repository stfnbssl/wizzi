...
function getPageMetadata(props) {
  ...
  const url = `${({"NODE_ENV":"development","SERVER_URL":"http://localhost:5000","API_SERVER_URL":"http://localhost:5000","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1626857087418}).PACKI_SERVER_URL}${props.id ? `/${props.id}` : ''}
    `;
...
//# sourceMappingURL=EditorView.e5aaf60e7d931a9f3fcf.chunk.js.map