/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\json\factory\step_1.js.ittf
    utc time: Tue, 03 Sep 2024 18:51:46 GMT
*/
/**
     Example: json_factory_step_1
...
var json_factory_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    var schema = 'js';
    var ittfContent = [
        'module', 
...
json_factory_step_1.__name = 'json_factory_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - json_factory_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- json_factory_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = json_factory_step_1;
