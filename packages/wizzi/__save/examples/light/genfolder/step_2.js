/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\light\genfolder\step_2.js.ittf
    utc time: Tue, 03 Sep 2024 18:51:46 GMT
*/
/**
     Example: light_genfolder_step_1
...
var light_genfolder_step_1 = function(step_callback) {
    ...
    wizziIndex.genFolder(path.join(__dirname, '..', 'templates', pkg.type), {
        pkg: pkg
     }, {
        destFolder: path.join(__dirname, pkg.name), 
        copyInclude: ['*'], 
        copyExclude: []
