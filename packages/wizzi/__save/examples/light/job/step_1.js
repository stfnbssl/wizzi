/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\light\job\step_1.js.ittf
...
var light_job_step_1 = function(step_callback) {
    ...
    wizziIndex.job(jobPath, {
        ...
        printObject('jobResults', jobResults)
    })
};
light_job_step_1.__name = 'light_job_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - light_job_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- light_job_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = light_job_step_1;
