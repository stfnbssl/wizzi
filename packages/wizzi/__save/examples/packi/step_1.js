/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\packi\step_1.js.ittf
    utc time: Tue, 03 Sep 2024 18:51:46 GMT
*/
/**
     Example: packi_step_1
...
var packi_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    const plugins = {
        items: [
    ...
    createPackiManager((err, packiManager) => {
        if (err) {
            console.log("[31m%s[0m", err);
            return ;
        }
        ...
        createPackifilesFromFs(genFolderPathFs, (err, folder1PackiFiles) => {
            ...
            console.log('packi_step_1.folder1PackiFiles', folder1PackiFiles, __filename);
            packiManager.generate(folder1PackiFiles, plugins, {
                modelRequestContext: {
                    metaCtx: {
                        name: "Hello"
                     }, 
                ...
                console.log('packiManager.generate.result', result);
            }
            )
        }
        )
...
packi_step_1.__name = 'packi_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - packi_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
