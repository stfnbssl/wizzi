/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\packi\step_2.js.ittf
    utc time: Tue, 03 Sep 2024 18:51:46 GMT
*/
/**
     Example: packi_step_2
...
var packi_step_2 = function(step_callback) {
    heading1('EXAMPLE')
    ...
    createPackiManager((err, packiManager) => {
        ...
        createPackifilesFromFs(genFolderPathFs, (err, folder1PackiFiles) => {
            ...
            packiManager.prettify(folder1PackiFiles, (err, result) => {
                if (err) {
                    console.log("[31m%s[0m", err);
                    return ;
                }
                console.log('packiManager.prettify.result', result);
            }
            )
        }
        )
...
packi_step_2.__name = 'packi_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - packi_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
