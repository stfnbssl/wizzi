/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\packi\step_3.js.ittf
    utc time: Tue, 03 Sep 2024 18:51:46 GMT
*/
/**
     Example: packi_step_3
...
var packi_step_3 = function(step_callback) {
    heading1('EXAMPLE')
    const plugins = {
        items: [
    ...
    createPackiManager((err, packiManager) => {
        ...
        var genFolderPathFs = path.join(__dirname, 'ittf', 'job_folder1');
        var friendsArray = [
            'arthur', 
            'mary'
        ];
...
packi_step_3.__name = 'packi_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - packi_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
