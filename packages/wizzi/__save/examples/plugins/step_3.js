/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\plugins\step_3.js.ittf
...
var mm_step_3 = function(step_callback) {
    heading1('EXAMPLE')
    ...
    createMetasManager({}, (err, mm) => {
        ...
        mm.getProvidedMetas((err, metaProvides) => {
            if (err) {
                console.log("[31m%s[0m", err);
                return ;
            }
            console.log('metaProvides', metaProvides);
        }
        )
    }
    )
};
mm_step_3.__name = 'mm_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - mm_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
