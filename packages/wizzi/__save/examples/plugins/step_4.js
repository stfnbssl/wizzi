...
var mm_step_4 = function(step_callback) {
    heading1('EXAMPLE')
...
mm_step_4.__name = 'mm_step_4';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - mm_step_4 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
