/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\wf\job\step_3.js.ittf
...
var jobs_2 = function(step_callback) {
    ...
    function execute(jobName, callback) {
        var jobPath = path.join(__dirname, 'ittf', jobName, 'index.wzjob.ittf');
        // Execute a wizzi job
        createWizziFactory({}, function(err, wf) {
            ...
            console.log('Created Wizzi Factory', __filename);
            console.log('executing job', jobPath, __filename);
            wf.executeJob({
                name: 'Job1 example', 
                path: jobPath, 
                ...
                printObject('result.persistResult', result.persistResult)
            })
        })
    }
};
