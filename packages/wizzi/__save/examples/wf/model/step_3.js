...
var wf_model_step_3 = function(step_callback) {
    heading1('EXAMPLE')
    var friendsArray = [
        'arthur', 
        'mary'
...
wf_model_step_3.__name = 'wf_model_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wf_model_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_model_step_3 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wf_model_step_3;
