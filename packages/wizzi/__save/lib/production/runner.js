...
var Runner = (function () {
    ...
    Runner.prototype.run = function(callback) {
        ...
        else if (this.productionStep.ittfDocumentProduction) {
    ...
    Runner.prototype._runOnModelInfo = function(modelInfo, callback) {
        ...
        if (this.productionStep.isWizziModelDomArtifact()) {
            ...
            return callback(error('999', '_runOnModelInfo', 'The production step is in an invalid state: ' + util.inspect(this.productionStep, {depth: 2})));
        }
    }
