/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\ittf\examples\json\job\step_1.js.ittf
*/
'use strict';
//
...
var json_job_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    ...
    wizziIndex.JsonComponents.createFsJson(documents, function(err, fsJson) {
        ...
        wizziIndex.jsonFactory(options, function(err, wf) {
            ...
            wf.executeJob({
                ...
                printObject('job.result', result)
                printObject('job.fsJson', fsJson)
                console.log('job.result', Object.keys(result));
                console.log('job.fsJson', Object.keys(fsJson));
                var files = {};
                fsJson.toFiles({
                ...
                printObject('generated.files', files)
            }
            )
        })
    })
};
json_job_step_1.__name = 'json_job_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - json_job_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- json_job_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = json_job_step_1;
