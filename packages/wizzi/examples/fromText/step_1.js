/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\fromText\step_1.js.ittf
    utc time: Thu, 18 Apr 2024 15:05:47 GMT
*/
'use strict';
/**
     Example: fromText_step_1
...
var fromText_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    createWizziFactory({}, function(err, wf) {
        ...
        wf.loadModelFromText([
            ...
            printEvaluatedNodes(result, 'html wizziModel')
            wf.loadModelAndGenerateArtifactFromText([
                ...
                printValue(result, 'html/document')
            })
        })
    })
};
fromText_step_1.__name = 'fromText_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - fromText_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- fromText_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = fromText_step_1;
