/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\light\model\step_1.js.ittf
    utc time: Thu, 18 Apr 2024 15:05:47 GMT
*/
'use strict';
/**
     Example: light_model_step_1
...
var light_model_step_1 = function(step_callback) {
    ...
    */
    wizziIndex.model(htmlFriendsPath, {
        ...
        */
        wizziIndex.gen(htmlFriendsPath, {
            friends: friendsArray
...
light_model_step_1.__name = 'light_model_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - light_model_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- light_model_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = light_model_step_1;
