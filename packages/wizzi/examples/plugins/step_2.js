/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\plugins\step_2.js.ittf
...
var mm_step_2 = function(step_callback) {
    ...
    createMetasManager({}, (err, mm) => {
        ...
        mm.getMetaProductionStarter({
         ...
         }, (err, metaProductionstarter) => {
        
            if (err) {
                console.log("[31m%s[0m", err);
                return ;
            }
            console.log('metaProductionstarter', metaProductionstarter, __filename);
        }
        )
    }
    )
