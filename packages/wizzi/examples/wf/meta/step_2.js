/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\wf\meta\step_2.js.ittf
    utc time: Thu, 18 Apr 2024 15:05:47 GMT
*/
'use strict';
/**
     Example: wf_meta_step_2
...
var wf_meta_step_2 = function(step_callback) {
    heading1('EXAMPLE')
    
    const folderTemplatesIndexPath = "folderTemplates/index.ittf.ittf";
    
    createPackifilesFromFs("C:/My/wizzi/stfnbssl/wizzi.cli/packages/wizzi.meta.package/.wizzi-override/ittf", (err, metaPackiFiles) => {
    
        if (err) {
            console.log("[31m%s[0m", err);
            return callback(err);
        }
        printValue('metaPackiFiles 1', stringify(Object.keys(metaPackiFiles), null, 2))
            ...
            wf_and_jsonFs.wf.metaGenerate(packiFilePrefix + folderTemplatesIndexPath, {
                ...
                jsonFsToPackiFiles(wf_and_jsonFs.jsonFs, '___template', function(err, templatePackiFiles) {
                    ...
                    jsonFsToPackiFiles(wf_and_jsonFs.jsonFs, '___wizzi', function(err, wizziPackiFiles) {
                        ...
                        writePackifiles(path.join(__dirname, 'out_meta_2'), wizziPackiFiles)
...
wf_meta_step_2.__name = 'wf_meta_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 2 - wf_meta_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_meta_step_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
