/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\wf\meta\step_4.js.ittf
...
const packiFilePrefixExtract = wizziIndex.constantsss.packiFilePrefixExtract;
...
var wf_meta_step_3 = function(step_callback) {
    ...
    createJsonWizziFactoryAndJsonFs({}, function(err, wf_and_jsonFs) {
        ...
        wf_and_jsonFs.wf.executeMetaProduction({
            ...
            console.log('wizziPackiFiles', wizziPackiFiles);
            writePackifiles(path.join(__dirname, 'out_step_4'), wizziPackiFiles)
        }
        )
    })
};
wf_meta_step_3.__name = 'wf_meta_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - wf_meta_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_meta_step_3 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
