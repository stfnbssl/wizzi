...
var wf_meta_step_6 = function(step_callback) {
    heading1('EXAMPLE')
    getMetaParameters();
    function getMetaParameters() {
        createJsonWizziFactoryAndJsonFs({}, function(err, wf_and_jsonFs) {
            ...
            wf_and_jsonFs.wf.getMetaParameters({
                ...
                writePackifiles(path.join(__dirname, 'output', 'metaParameters'), metaParameters)
            }
            )
        })
    }
};
wf_meta_step_6.__name = 'wf_meta_step_6';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - wf_meta_step_6 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_meta_step_6 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
