    ...
    function getMetaParameters() {
        createJsonWizziFactoryAndJsonFs({}, function(err, wf_and_jsonFs) {
            ...
            wf_and_jsonFs.wf.getMetaParameters({
                ...
                console.log('parameters', Object.keys(parameters), __filename);
                file.write(path.join(__dirname, 'output', 'parameters.json'), stringify(parameters, null, 4))
            }
            )
        })
    }
};
wf_meta_step_7.__name = 'wf_meta_step_7';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - wf_meta_step_7 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_meta_step_7 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
