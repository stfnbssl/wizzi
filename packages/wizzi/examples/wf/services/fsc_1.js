/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\examples\wf\services\fsc_1.js.ittf
...
var fsc_1 = function(step_callback) {
    heading1('EXAMPLE')
    var FactoryServiceContext = wizziIndex.FactoryServiceContext;
    var fscInstance = new FactoryServiceContext();
    fscInstance.addDebugObject('packi', 'dbg1', getSamplePackiFile1())
    fscInstance.addDebugObject('packi', 'dbg1', getSamplePackiFile1())
    fscInstance.dumpDebugObjects({
        kind: 'packi', 
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - fsc_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
