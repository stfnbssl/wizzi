...
var wf_wizzify_step_1 = function(step_callback) {
    ...
    createWizziFactory({}, function(err, wf) {
        ...
        wf.getWizziIttf(htmlSourcePath, 'html', function(err, ittfDocument) {
            if (err) {
                console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                console.log("[31m%s[0m", 'err', err);
                throw new Error(err.message);
            ...
            wf.getWizziIttf(cssSourcePath, 'css', function(err, ittfDocument) {
                if (err) {
                    console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                    console.log("[31m%s[0m", 'err', err);
                    throw new Error(err.message);
                ...
                wf.getWizziIttf(svgSourcePath, 'svg', function(err, ittfDocument) {
                    if (err) {
                        console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                        console.log("[31m%s[0m", 'err', err);
                        throw new Error(err.message);
                    ...
                    wf.getWizziIttf(jsSourcePath, 'js', function(err, ittfDocument) {
                        if (err) {
                            console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                            console.log("[31m%s[0m", 'err', err);
                            throw new Error(err.message);
                        ...
                        wf.getWizziIttf(graphqlSourcePath, 'graphql', function(err, ittfDocument) {
                            if (err) {
                                console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                                console.log("[31m%s[0m", 'err', err);
                                throw new Error(err.message);
                            ...
                            wf.getWizziIttf(tsSourcePath, 'ts', function(err, ittfDocument) {
                                if (err) {
                                    console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                                    console.log("[31m%s[0m", 'err', err);
                                    throw new Error(err.message);
                                ...
                                wf.getWizziIttf(jsonSourcePath, 'json', function(err, ittfDocument) {
                                    if (err) {
                                        console.log("[31m%s[0m", 'Test error >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
                                        console.log("[31m%s[0m", 'err', err);
                                        throw new Error(err.message);
