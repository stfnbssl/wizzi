/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\lib\production\artifact\line.js.ittf
...
var Line = (function () {
    ...
    Line.prototype.toStream = function(stream, ctx) {
        ...
        if (this.containsFilePath) {
            ...
            stream.write(spaces(this.indentValue * this.options.indentSpaces) + this.text.join(''))
        }
    }
