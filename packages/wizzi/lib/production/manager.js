...
var ProductionManager = (function () {
    ...
    */
    ...
    ProductionManager.prototype.getLoadModel = function(schemaName) {
        ...
        console.log('wizzi.productionManager.getLoadModel.globalContextObject', this.globalContextObject, __filename);
    ...
    ProductionManager.prototype.loadWfjob = function(ittfDocumentUri, context, callback) {
        ...
        console.log('wizzi.production.productionManager.loadWfjob.ittfDocumentUri', ittfDocumentUri, __filename);
        ...
        console.log('wizzi.production.productionManager.loadWfjob.context', context, __filename);
        console.log('wizzi.production.productionManager.loadWfjob.ctx,ctx.mTreeBuildUpContext', Object.keys(ctx), ctx.mTreeBuildUpContext, this.wizziFactory.globalContext, __filename);
        console.log('wizzi.production.productionManager.loadWfjob.ctx.__productionManager.globalContext()', ctx.__productionManager.globalContext(), __filename);
        this.wfjobLoadModel(ittfDocumentUri, this.wizziFactory.createLoadContext(context, this), callback)
    }
