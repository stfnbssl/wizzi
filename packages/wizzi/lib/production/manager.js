...
/**
     ...
     It executes `wfjob` wizzi models or production steps built programmaticaly.
*/
/**
    ...
    */
    ProductionManager.prototype.addWzjobRequest = function(jobRequest) {
        ...
        if (verify.isObject(jobRequest.wfjob) === false) {
            return error(
                'InvalidArgument', 'addWzjobRequest', { parameter: 'jobRequest.wfjob', message: 'The jobRequest.wfjob parameter must be an object. Received: ' + jobRequest.wfjob }
            );
        }
        if (verify.isNotEmpty(jobRequest.wfjob.ittfDocumentUri) === false) {
            return error(
                'InvalidArgument', 'addWzjobRequest', { parameter: 'jobRequest.wfjob.ittfDocumentUri', message: 'The jobRequest.wfjob.ittfDocumentUri parameter must be a string. Received: ' + jobRequest.wfjob.ittfDocumentUri }
            );
        }
...
var AsyncInitializeJobRequests = {
    run: function(jobRequest, callback) {
        ...
        var wzjobIttfDocumentUri = jobRequest.wfjob.ittfDocumentUri;
        ...
        AsyncRecurseWzjobLoad(wzjobLoadRequest, function(err, result) {
            ...
            for (i=0; i<i_len; i++) {
                ...
                globalModelInfoConfig.wfjob = wzjobIttfDocumentUri;
            ...
            for (i=0; i<i_len; i++) {
                ...
                productionStepConfig.wfjob = wzjobIttfDocumentUri;
                if (pman.options.trace) {
