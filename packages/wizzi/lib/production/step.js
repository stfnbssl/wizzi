...
/**
     ...
     by the wizzi/lib/production/wfjob module
    ...
    ProductionStep.prototype.getItemsToPersistToFile = function(callback) {
        ...
        for (i=0; i<i_len; i++) {
            ...
            if (this.isModelCollectionArtifact()) {
                ...
                if (this.fileCtx) {
                    console.log('filePath.before', filePath, __filename);
                    filePath = interpolateFilename(filePath, this.fileCtx)
                    ;
                    console.log('filePath.after', filePath, __filename);
                }
                var persisteable = {
                    productionStep: this, 
                    genContext: genContext, 
