...
class WizziFactory {
    ...
    */
    generateFolderArtifacts(ittfFolderUri, requestContext, options, callback) {
        ...
        console.log('wizzi.WizziFactory.generateFolderArtifacts.ittfFolderUri,fileCtx', ittfFolderUri, fileCtx, __filename);
        console.log('wizzi.wizzifactory.generateFolderArtifacts.object.keys(modelRequestContext)', Object.keys(modelRequestContext), __filename);
        try {
    ...
    */
    ...
    /**
         ...
         string ittfText
    */
    getWizziIttf(tobeWizzifiedUri, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    /**
         ...
         string ittfText
    */
    getWizziIttfFromText(tobeWizzifiedText, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    /**
         ...
         object ittfTree
    */
    getWizziTree(tobeWizzifiedUri, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    /**
         ...
         string ittfText
    */
    getWizziTreeFromText(tobeWizzifiedText, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    /**
         ...
         object AST
    */
    getCodeAST(tobeWizzifiedUri, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    /**
         ...
         string ittfText
    */
    getCodeASTFromText(tobeWizzifiedText, wizzifierName, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    */
    getMetaParameters(options, callback) {
        ...
        console.log('wizziFactory.getMetaParameters.options', options, __filename);
        this.getMetasManager({}, (err, mm) => {
