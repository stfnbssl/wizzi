...
var WizziFactory = (function () {
    ...
    */
    ...
    /**
         ...
         true|false
    */
    WizziFactory.prototype.canWizzify = function(schemaName) {
        if (verify.isNotEmpty(schemaName) === false) {
            return error(
    ...
    WizziFactory.prototype.executeMetaProduction = function(options, callback) {
        ...
        this.getMetasManager({}, (err, mm) => {
            ...
            mm.getMetaProductionStarter({
                ...
                var testMergeOptionsProductions = this.mergeOptionsProductions(metaPackiFiles, options);
                if (testMergeOptionsProductions && testMergeOptionsProductions.__is_error) {
                    console.log("[31m%s[0m", '__is_error Error merging meta plugins and options productions', testMergeOptionsProductions);
                    return callback(testMergeOptionsProductions);
                }
    ...
    */
    WizziFactory.prototype.mergeOptionsProductions = function(metaPackiFiles, options) {
        if (options.productions) {
            const optionsPackiFiles = packiUtils.createMetaPackifilesFromWizziHub(options.productions);
            for (var k in optionsPackiFiles) {
                ...
                metaPackiFiles[k] = optionsPackiFiles[k];
            }
        }
        return {
                ok: true
    ...
    /**
         ...
         optional
    */
    WizziFactory.prototype.prepareFilesAndGetFolderTemplatesIndex = function(metaPackiFiles, options) {
    ...
    WizziFactory.prototype.getMetaParameters = function(options, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    WizziFactory.prototype.getMetaProductions = function(options, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    WizziFactory.prototype.getCategoriesAndMetaProductions = function(options, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    */
    ...
    WizziFactory.prototype.getPackiFilesFromJsonFactory = function(destFolder, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
